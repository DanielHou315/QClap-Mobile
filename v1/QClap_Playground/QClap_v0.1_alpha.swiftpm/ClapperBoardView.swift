...
struct ClapperBoardView: View {
    ...
    // @State var qrCodeImageView: UIImageView
    ...
    var body: some View {
        ...
        HStack{
            ...
            VStack{
                // Production Name
                HStack{
                    Text("Production: ").foregroundColor(.black).frame(alignment:.leading).font(.system(size:46))
                ...
                HStack {
                    VStack{
                        Text("Scene").foregroundColor(.black).frame(alignment:.bottomLeading).font(.system(size:46))
                        Spacer()
                    ...
                    Divider()
                    VStack{
                        Text("Take").foregroundColor(.black).frame(alignment: .topLeading).font(.system(size:46))
                        Spacer()
                    ...
                    Divider()
                    VStack{
                        Text("Roll").foregroundColor(.black).frame(alignment: .topLeading).font(.system(size:46))
                        Spacer()
